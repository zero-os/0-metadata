...
func (c The_0_Metadata) doReqWithBody(method, urlStr string, data interface{}, headers, queryParams map[string]interface{}) (*http.Response, error) {
...
func (c The_0_Metadata) doReqNoBody(method, urlStr string, headers, queryParams map[string]interface{}) (*http.Response, error) {
	return c.doReq(method, urlStr, nil, headers, queryParams)
}

func (c The_0_Metadata) doReq(method, urlStr string, body io.Reader, headers, queryParams map[string]interface{}) (*http.Response, error) {
	// create the request
